...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "violet",
    name: "Violet",
    nameKey: "theme.violet.name",
    tagline: "The default — confident, slightly playful.",
    taglineKey: "theme.violet.tagline",
  ...
  },
  {
    ...
    taglineKey: "theme.emerald.tagline",
    swatch: "oklch(0.62 0.16 162)",
  },
  {
    id: "cobalt",
    name: "Cobalt",
    nameKey: "theme.cobalt.name",
    tagline: "Clean B2B-SaaS blue — calm and product-y.",
    taglineKey: "theme.cobalt.tagline",
  ...
  },
  {
    ...
    taglineKey: "theme.amber.tagline",
