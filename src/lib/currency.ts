...
export const CURRENCIES: CurrencyOption[] = [
  { code: "USD", label: "US Dollar", labelKey: "currency.usd", symbol: "$" },
  { code: "EUR", label: "Euro", labelKey: "currency.eur", symbol: "€" },
  { code: "GBP", label: "British Pound", labelKey: "currency.gbp", symbol: "£" },
  { code: "INR", label: "Indian Rupee", labelKey: "currency.inr", symbol: "₹" },
  { code: "AUD", label: "Australian Dollar", labelKey: "currency.aud", symbol: "A$" },
  { code: "CAD", label: "Canadian Dollar", labelKey: "currency.cad", symbol: "C$" },
  { code: "BRL", label: "Brazilian Real", labelKey: "currency.brl", symbol: "R$" },
  { code: "JPY", label: "Japanese Yen", labelKey: "currency.jpy", symbol: "¥" },
  { code: "CNY", label: "Chinese Yuan", labelKey: "currency.cny", symbol: "¥" },
  { code: "AED", label: "UAE Dirham", labelKey: "currency.aed", symbol: "د.إ" },
  { code: "ZAR", label: "South African Rand", labelKey: "currency.zar", symbol: "R" },
  { code: "NGN", label: "Nigerian Naira", labelKey: "currency.ngn", symbol: "₦" },
  { code: "SGD", label: "Singapore Dollar", labelKey: "currency.sgd", symbol: "S$" },
  { code: "MXN", label: "Mexican Peso", labelKey: "currency.mxn", symbol: "$" },
];
