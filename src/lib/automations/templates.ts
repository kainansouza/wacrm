...
export const AUTOMATION_TEMPLATES: Record<TemplateSlug, AutomationTemplateDefinition> = {
  welcome_message: {
    ...
    nameKey: 'automationTemplate.welcome.name',
    description: 'Auto-reply to first-time contacts with a greeting.',
    descriptionKey: 'automationTemplate.welcome.description',
  ...
  out_of_office: {
    slug: 'out_of_office',
    name: 'Out of Office',
    nameKey: 'automationTemplate.outOfOffice.name',
    description: 'Auto-reply during off-hours so nobody is left waiting.',
    descriptionKey: 'automationTemplate.outOfOffice.description',
  ...
  lead_qualifier: {
    slug: 'lead_qualifier',
    name: 'Lead Qualifier',
    nameKey: 'automationTemplate.leadQualifier.name',
    description: 'Ask qualification questions to filter inbound leads.',
    descriptionKey: 'automationTemplate.leadQualifier.description',
  ...
  follow_up_reminder: {
    ...
    nameKey: 'automationTemplate.followUp.name',
    description: 'Send a nudge if a contact has not replied within 24 hours.',
    descriptionKey: 'automationTemplate.followUp.description',
    trigger_type: 'new_message_received',
    trigger_config: {},
    steps: [
      {
