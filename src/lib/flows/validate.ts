...
export function validateFlowForActivation(
  ...
  if (!flow.name || !flow.name.trim()) {
    issues.push({
      ...
      messageKey: "flowValidation.nameRequired",
    });
  }
  ...
  if (!flow.entry_node_id) {
    issues.push({
      ...
      messageKey: "flowValidation.entryNodeRequired",
    });
  }
  ...
  if (nodes.length === 0) {
    issues.push({
      ...
      messageKey: "flowValidation.atLeastOneNode",
    });
  }
  ...
  if (flow.entry_node_id && !keys.has(flow.entry_node_id)) {
    issues.push({
      ...
      messageKey: "flowValidation.entryNodeNotExist",
    });
  }
  ...
  for (const n of nodes) {
    if (seen.has(n.node_key)) {
      issues.push({
        ...
        messageKey: "flowValidation.duplicateNodeKey",
      });
    }
    seen.add(n.node_key);
  }
    ...
    for (const n of nodes) {
      if (!reached.has(n.node_key)) {
        issues.push({
          ...
          messageKey: "flowValidation.nodeUnreachable",
        });
      }
    }
  }
  ...
  if (trigger_type === "keyword") {
    ...
    if (!keywords || keywords.length === 0) {
      issues.push({
        ...
        messageKey: "flowValidation.keywordRequired",
      });
    } else {
      ...
      if (blanks > 0) {
        issues.push({
          ...
          messageKey: "flowValidation.keywordBlanks",
        });
      }
    }
  }
  ...
  switch (node.node_type) {
    case "start": {
      ...
      if (!cfg.next_node_key) {
        issues.push({
          ...
          messageKey: "flowValidation.startNodeNextRequired",
        });
        ...
        issues.push({
          ...
          messageKey: "flowValidation.startNodeTargetNotExist",
        });
      }
      break;
    }
    ...
    case "send_message": {
      ...
      if (!cfg.text?.trim()) {
        issues.push({
          ...
          messageKey: "flowValidation.sendMessageTextRequired",
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          messageKey: "flowValidation.sendMessageNextRequired",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          messageKey: "flowValidation.sendMessageTargetNotExist",
        });
      }
      break;
    }
    ...
    case "send_media": {
      ...
      if (
        ...
        issues.push({
          ...
          messageKey: "flowValidation.sendMediaTypeRequired",
        });
      }
      if (!cfg.media_url?.trim()) {
        issues.push({
          ...
          messageKey: "flowValidation.sendMediaUrlRequired",
        });
      }
      ...
      if (cfg.caption && cfg.caption.length > INTERACTIVE_LIMITS.bodyMaxLength) {
        issues.push({
          ...
          messageKey: "flowValidation.captionTooLong",
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          messageKey: "flowValidation.sendMediaNextRequired",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          messageKey: "flowValidation.sendMediaTargetNotExist",
        });
      }
      break;
    }
    ...
    case "send_buttons": {
      ...
      if (!cfg.text?.trim()) {
        issues.push({
          ...
          messageKey: "flowValidation.sendButtonsTextRequired",
        });
      }
      ...
      if (btns.length < 1) {
        issues.push({
          ...
          messageKey: "flowValidation.sendButtonsMinButtons",
        });
      }
      if (btns.length > INTERACTIVE_LIMITS.maxButtons) {
        issues.push({
          ...
          messageKey: "flowValidation.sendButtonsMaxButtons",
        });
      }
      ...
      btns.forEach((b, i) => {
        ...
        if (!b.reply_id?.trim()) {
          issues.push({
            ...
            messageKey: "flowValidation.buttonReplyIdRequired",
          });
          ...
          issues.push({
            ...
            messageKey: "flowValidation.buttonReplyIdDuplicate",
          });
        }
        ...
        if (!b.title?.trim()) {
          issues.push({
            ...
            messageKey: "flowValidation.buttonTitleRequired",
          });
          ...
          issues.push({
            ...
            messageKey: "flowValidation.buttonTitleTooLong",
          });
        }
        ...
        if (!b.next_node_key) {
          issues.push({
            ...
            messageKey: "flowValidation.buttonNextRequired",
          });
          ...
          issues.push({
            ...
            messageKey: "flowValidation.buttonTargetNotExist",
          });
        }
      });
      break;
    ...
    case "send_list": {
      ...
      if (!cfg.text?.trim()) {
        issues.push({
          ...
          messageKey: "flowValidation.sendListTextRequired",
        });
      }
      if (!cfg.button_label?.trim()) {
        issues.push({
          ...
          messageKey: "flowValidation.sendListButtonLabelRequired",
        });
      }
      ...
      if (totalRows < 1) {
        issues.push({
          ...
          messageKey: "flowValidation.sendListMinRows",
        });
      }
      if (totalRows > INTERACTIVE_LIMITS.maxListRowsTotal) {
        issues.push({
          ...
          messageKey: "flowValidation.sendListMaxRows",
        });
      }
      const seenIds = new Set<string>();
        ...
        rows.forEach((row, ri) => {
          ...
          if (!row.reply_id?.trim()) {
            issues.push({
              ...
              messageKey: "flowValidation.listRowReplyIdRequired",
            });
            ...
            issues.push({
              ...
              messageKey: "flowValidation.listRowReplyIdDuplicate",
            });
          }
          ...
          if (!row.title?.trim()) {
            issues.push({
              ...
              messageKey: "flowValidation.listRowTitleRequired",
            });
          } else if (
            ...
            issues.push({
              ...
              messageKey: "flowValidation.listRowTitleTooLong",
            });
          }
          if (
            row.description &&
            ...
            issues.push({
              ...
              messageKey: "flowValidation.listRowDescTooLong",
            });
          }
          if (!row.next_node_key) {
            issues.push({
              ...
              messageKey: "flowValidation.listRowNextRequired",
            });
            ...
            issues.push({
              ...
              messageKey: "flowValidation.listRowTargetNotExist",
            });
          }
        });
      });
    ...
    case "collect_input": {
      ...
      if (!cfg.prompt_text?.trim()) {
        issues.push({
          ...
          messageKey: "flowValidation.collectInputPromptRequired",
        });
      }
      if (!cfg.var_key?.trim()) {
        issues.push({
          ...
          messageKey: "flowValidation.collectInputVarKeyRequired",
        });
        ...
        issues.push({
          ...
          messageKey: "flowValidation.collectInputVarKeyInvalid",
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          messageKey: "flowValidation.collectInputNextRequired",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          messageKey: "flowValidation.collectInputTargetNotExist",
        });
      }
      break;
    }
    ...
    case "condition": {
      ...
      if (!cfg.subject || !["var", "tag", "contact_field"].includes(cfg.subject)) {
        issues.push({
          ...
          messageKey: "flowValidation.conditionSubjectRequired",
        });
      }
      if (!cfg.subject_key?.trim()) {
        issues.push({
          ...
          messageKey: "flowValidation.conditionSubjectKeyRequired",
        });
      }
      if (
        !cfg.operator ||
        ...
        issues.push({
          ...
          messageKey: "flowValidation.conditionOperatorRequired",
        });
      } else if (
        ...
        issues.push({
          ...
          messageKey: "flowValidation.conditionOperatorValueExpected",
        });
      }
      for (const branch of ["true_next", "false_next"] as const) {
        ...
        if (!key) {
          issues.push({
            ...
            messageKey: branch === "true_next" ? "flowValidation.conditionTrueBranchRequired" : "flowValidation.conditionFalseBranchRequired",
          });
          ...
          issues.push({
            ...
            messageKey: "flowValidation.conditionBranchTargetNotExist",
          });
        }
      }
      break;
    ...
    case "set_tag": {
      ...
      if (!cfg.mode || !["add", "remove"].includes(cfg.mode)) {
        issues.push({
          ...
          messageKey: "flowValidation.setTagModeRequired",
        });
      }
      if (!cfg.tag_id) {
        issues.push({
          ...
          messageKey: "flowValidation.setTagTagRequired",
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          messageKey: "flowValidation.setTagNextRequired",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          messageKey: "flowValidation.setTagTargetNotExist",
        });
      }
      break;
    }
    ...
    default:
      issues.push({
        ...
        messageKey: "flowValidation.unknownNodeType",
      });
  }
