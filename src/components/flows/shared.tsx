...
> = {
  start: {
    ...
    labelKey: "flows.nodeStart",
    blurbKey: "flows.nodeStartBlurb",
  },
  send_message: {
    label: "Send message",
    icon: MessageCircle,
    ...
    labelKey: "flows.nodeSendMessage",
    blurbKey: "flows.nodeSendMessageBlurb",
  },
  send_buttons: {
    label: "Send buttons",
    icon: ListChecks,
    ...
    labelKey: "flows.nodeSendButtons",
    blurbKey: "flows.nodeSendButtonsBlurb",
  },
  send_list: {
    label: "Send list",
    icon: ListPlus,
    ...
    labelKey: "flows.nodeSendList",
    blurbKey: "flows.nodeSendListBlurb",
  },
  send_media: {
    label: "Send media",
    icon: Paperclip,
    ...
    labelKey: "flows.nodeSendMedia",
    blurbKey: "flows.nodeSendMediaBlurb",
  },
  collect_input: {
    label: "Collect input",
    icon: Inbox,
    ...
    labelKey: "flows.nodeCollectInput",
    blurbKey: "flows.nodeCollectInputBlurb",
  },
  condition: {
    label: "If / else",
    icon: GitFork,
    ...
    labelKey: "flows.nodeCondition",
    blurbKey: "flows.nodeConditionBlurb",
  },
  set_tag: {
    label: "Tag contact",
    icon: Tag,
    ...
    labelKey: "flows.nodeSetTag",
    blurbKey: "flows.nodeSetTagBlurb",
  },
  handoff: {
    ...
    labelKey: "flows.nodeHandoff",
    blurbKey: "flows.nodeHandoffBlurb",
  },
  end: {
    label: "End",
    icon: Flag,
    ...
    blurb: "Ends the flow",
    labelKey: "flows.nodeEnd",
    blurbKey: "flows.nodeEndBlurb",
  },
};
