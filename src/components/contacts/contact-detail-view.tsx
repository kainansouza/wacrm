...
export function ContactDetailView({
  ...
  async function saveDetails() {
    ...
    if (error) {
      toast.error(t('toast.failedUpdateContact'));
    } else {
  ...
  async function saveCustomFields() {
    ...
    try {
      ...
      toast.success(t('toast.customFieldsSaved'));
    } catch {
      toast.error(t('toast.failedSaveCustomFields'));
    }
              ...
              <TabsContent value="details" className="flex-1 overflow-y-auto px-4 py-3">
                <div className="space-y-3">
                  <div className="space-y-1.5">
                    <Label className="text-muted-foreground text-xs">{t('contacts.form.nameLabel')}</Label>
                    <Input
                      value={editName}
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-muted-foreground text-xs">
                      {t('contacts.form.phoneLabel')} <span className="text-red-400">*</span>
                    </Label>
                    <Input
                      value={editPhone}
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-muted-foreground text-xs">{t('contacts.form.emailLabel')}</Label>
                    <Input
                      value={editEmail}
              ...
              <TabsContent value="tags" className="flex-1 overflow-y-auto px-4 py-3">
                <div className="space-y-3">
                  <p className="text-xs text-muted-foreground">
                    {t('contacts.detail.tagsInstruction')}
                  </p>
                  {allTags.length === 0 ? (
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          placeholder={t('contacts.detail.customFieldEnter', { name: field.field_name })}
