...
const contactFields = [
  { value: 'name', labelKey: 'broadcasts.contactFieldName' },
  { value: 'phone', labelKey: 'broadcasts.phoneNumber' },
  { value: 'email', labelKey: 'broadcasts.emailAddress' },
  { value: 'company', labelKey: 'broadcasts.company' },
];
    ...
    <div className="space-y-6">
      ...
      {mediaHeaderType && (
        <div className="rounded-xl border border-border bg-card/50 p-4">
          <div className="mb-3 flex items-center gap-2">
            ...
            <p className="text-sm font-medium text-foreground">{t('broadcasts.headerMedia')}</p>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent className="border-border bg-popover">
                        <SelectItem value="static">{t('broadcasts.staticValue')}</SelectItem>
                        <SelectItem value="field">{t('broadcasts.contactField')}</SelectItem>
                        <SelectItem value="custom_field">
                          {t('broadcasts.customField')}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
      ...
      {unmappedKeys.length > 0 && (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-300">
          {t('broadcasts.mapEveryPlaceholder')} — still missing{' '}
