...
const audienceOptions: {
  ...
  {
    type: 'all',
    labelKey: 'broadcasts.audienceAll',
    descKey: 'broadcasts.audienceAllDesc',
    icon: Users,
  },
  {
    type: 'tags',
    labelKey: 'broadcasts.audienceTags',
    descKey: 'broadcasts.audienceTagsDesc',
    icon: Tags,
  },
  {
    type: 'custom_field',
    labelKey: 'broadcasts.audienceCustomField',
    descKey: 'broadcasts.audienceCustomFieldDesc',
    icon: Filter,
  },
  {
    type: 'csv',
    labelKey: 'broadcasts.audienceCSV',
    descKey: 'broadcasts.audienceCSVDesc',
    icon: Upload,
  },
];

const OPERATOR_OPTIONS: { value: CustomFieldOperator; labelKey: string }[] = [
  { value: 'is', labelKey: 'broadcasts.operatorIs' },
  { value: 'is_not', labelKey: 'broadcasts.operatorIsNot' },
  { value: 'contains', labelKey: 'broadcasts.operatorContains' },
];
        ...
        {loadingCount ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-foreground">
              {t('broadcasts.estimatedRecipients', { N: estimatedCount.toLocaleString() })}
            </span>
          </div>
        ) : (
          <p className="text-xs text-muted-foreground">
