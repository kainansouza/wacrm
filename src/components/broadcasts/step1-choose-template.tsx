    ...
    <div className="space-y-6">
      ...
      {templates.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-border bg-card/50">
          ...
          <p className="text-sm text-muted-foreground">{t('broadcasts.step1NoTemplates')}</p>
          <p className="mt-1 text-xs text-muted-foreground">{t('broadcasts.step1CreateTemplate')}</p>
        </div>
      ) : (
