...
export function TagManager() {
  ...
  async function fetchTags(userId: string) {
    try {
      ...
      toast.error(t('toast.failedLoadTags'));
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleCreate() {
    if (!newTagName.trim()) {
      toast.error(t('toast.tagNameRequired'));
      return;
    }
    ...
    try {
      ...
      toast.error(t('toast.failedCreateTag'));
    } finally {
      setSaving(false);
    }
  }
  ...
  async function handleDelete() {
    ...
    try {
      ...
      toast.error(t('toast.failedDeleteTag'));
    } finally {
      setDeleting(false);
    }
  }
                ...
                {tags.map((tag) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      aria-label={t('settings.fields.confirmDeleteTag', { name: tag.name })}
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              {t('settings.fields.confirmDeleteTag', { name: tagToDelete?.name ?? '' })}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
