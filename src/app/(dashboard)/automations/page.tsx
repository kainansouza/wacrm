...
export default function AutomationsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {showTemplates && (
        <section>
          <h2 className="mb-3 text-sm font-semibold text-muted-foreground">{t('automations.quickStartTemplates')}</h2>
      ...
      <Dialog open={!!pendingDelete} onOpenChange={(v) => !v && setPendingDelete(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t('automations.deleteConfirmTitle')}</DialogTitle>
            <DialogDescription>
              {t('automations.deleteConfirmDescription', { name: pendingDelete?.name ?? "" })}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
        ...
        >
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
            ...
            <span className="tabular-nums">
              {t('automations.runs', { N: automation.execution_count })}
            </span>
