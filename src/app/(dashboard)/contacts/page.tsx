    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {t('contacts.description')} {totalCount > 0 && t('contacts.totalContacts', { N: totalCount })}
          </p>
        </div>
      ...
      {selected.size > 0 && (
        <div className="flex items-center justify-between gap-4 rounded-lg border border-border bg-muted/40 px-4 py-2">
          <p className="text-sm text-foreground">
            {t('contacts.bulkSelected', { N: selected.size })}
          </p>
          <div className="flex items-center gap-2">
            <Button
              variant="ghost"
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-border hover:bg-transparent">
              ...
              <TableHead className="text-muted-foreground">{t('contacts.tableName')}</TableHead>
              <TableHead className="text-muted-foreground">{t('contacts.tablePhone')}</TableHead>
              <TableHead className="text-muted-foreground hidden md:table-cell">{t('contacts.tableEmail')}</TableHead>
              <TableHead className="text-muted-foreground hidden lg:table-cell">{t('contacts.tableCompany')}</TableHead>
              <TableHead className="text-muted-foreground hidden md:table-cell">{t('contacts.tableTags')}</TableHead>
              <TableHead className="text-muted-foreground hidden lg:table-cell">{t('contacts.tableCreated')}</TableHead>
              ...
              contacts.map((contact) => (
                ...
                >
                  ...
                  <TableCell className="text-foreground font-medium">
                    {contact.name || <span className="text-muted-foreground italic">{t('common.unnamed')}</span>}
                  </TableCell>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs text-muted-foreground px-2">
              {t('contacts.paginationOf', { page: page + 1, pages: totalPages })}
            </span>
            <Button
              variant="outline"
              size="icon-sm"
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">{t('contacts.deleteDialog.title')}</DialogTitle>
          ...
          <DialogFooter className="bg-popover border-border">
            ...
            >
              ...
              {t('contacts.deleteDialog.delete')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
        ...
        <DialogContent className="bg-popover border-border text-popover-foreground sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-popover-foreground">
              {t('contacts.deleteDialog.titleBulk', { N: selected.size })}
            </DialogTitle>
            <DialogDescription className="text-muted-foreground">
              {t('contacts.deleteDialog.descriptionBulk', { N: selected.size })}
            </DialogDescription>
          </DialogHeader>
          <DialogFooter className="bg-popover border-border">
            <Button
