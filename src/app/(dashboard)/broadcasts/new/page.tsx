...
const steps = [
  { labelKey: 'broadcasts.wizardStep1', key: 'template' },
  { labelKey: 'broadcasts.wizardStep2', key: 'audience' },
  { labelKey: 'broadcasts.wizardStep3', key: 'personalize' },
  { labelKey: 'broadcasts.wizardStep4', key: 'send' },
] as const;
...
export default function NewBroadcastPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-foreground">{t('broadcasts.newBroadcast')}</h1>
      </div>
