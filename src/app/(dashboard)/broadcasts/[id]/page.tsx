...
function FunnelChart({ steps }: { steps: FunnelStep[] }) {
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-4">
      <h3 className="mb-4 text-sm font-medium text-foreground">{t('broadcasts.funnelChart')}</h3>
...
export default function BroadcastDetailPage() {
  ...
  const funnelSteps: FunnelStep[] = [
    { label: t('broadcasts.detailSent'), value: broadcast.sent_count, color: 'bg-primary' },
    { label: t('broadcasts.detailDelivered'), value: broadcast.delivered_count, color: 'bg-teal-500' },
    { label: t('broadcasts.detailRead'), value: broadcast.read_count, color: 'bg-blue-500' },
    { label: t('broadcasts.detailReplied'), value: broadcast.replied_count, color: 'bg-indigo-500' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        {confirmDelete ? (
          <div className="flex items-center gap-2 rounded-md border border-red-500/30 bg-red-500/10 px-3 py-1.5 text-sm">
            <span className="text-red-300">{t('broadcasts.deleteConfirmTitle')}</span>
            <Button
              variant="outline"
              size="sm"
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        <StatCard
          label={t('broadcasts.detailTotalRecipients')}
        ...
        />
        <StatCard
          label={t('broadcasts.detailDelivered')}
        ...
        />
        <StatCard
          label={t('broadcasts.detailReplied')}
        ...
        />
        <StatCard
          label={t('broadcasts.detailFailed')}
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-border hover:bg-transparent">
                  ...
                  <TableHead className="text-muted-foreground">{t('broadcasts.detailTableStatus')}</TableHead>
                  ...
                  <TableHead className="text-muted-foreground">{t('broadcasts.detailTableRead')}</TableHead>
                  ...
                  return (
                    <TableRow key={recipient.id} className="border-border">
                      <TableCell className="font-medium text-foreground">
                        {recipient.contact?.name ?? t('common.unknown')}
                      </TableCell>
